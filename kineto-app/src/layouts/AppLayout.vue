      ...
      <nav class="sidebar-nav">
        <ul>
          ...
          <template v-if="authStore.userRole === 'COMPANY_ADMIN'">
            ...
            <li>
              <router-link to="/app/company/approvals" class="nav-link" active-class="active" @click="closeMobileSidebar">
                <i class="fas fa-tasks nav-icon" title="Approvals"></i>
                <span v-if="!isSidebarCollapsed">Approvals</span>
              </router-link>
            </li>
            <li>
              <router-link to="/app/company/reports" class="nav-link" active-class="active" @click="closeMobileSidebar">
                <i class="fas fa-chart-bar nav-icon" title="Reports"></i>
